package com.why.project.androidswitchforebackdemo;
 ...
 * Used Android前后台状态判断及锁屏操作
 * https://www.jianshu.com/p/d243b32b699c
 */
...
public class MyApplication extends Application {
	...
	public void onCreate() {
		super.onCreate();
		registerActivityLifecycleCallbacks(new AppForeBackStatusCallback());//注册activity生命周期监听
	}


	class AppForeBackStatusCallback implements Application.ActivityLifecycleCallbacks {
		 ...
		 * 最大无需解锁时长 15秒 单位：毫秒
		 */
		private final static long MAX_UNLOCK_DURATION = 15 * 1000;
